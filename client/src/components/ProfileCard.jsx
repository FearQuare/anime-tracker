    ...
    return (
        <div className="flex flex-col items-center h-full w-full md:w-3/10 lg:w-1/5">
            ...
            <div className="card bg-base-300 w-full shadow-sm text-primary flex flex-col items-center p-3">
                ...
                {sectionSelected == 'settings' ? <button className="btn disabled w-full rounded-lg hover:cursor-not-allowed">Settings</button> : <button className="btn btn-soft btn-primary w-full" onClick={handleSettingsSelected}>Settings</button>}
            </div>
